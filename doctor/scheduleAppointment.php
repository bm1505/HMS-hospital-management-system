...
<head>
    ...
    <!-- Google Fonts for Doctor-themed design -->
    ...
    <style>
        ...
        .form-section, .table-section {
            padding: 20px;
            background-color:rgb(118, 188, 235);
            border: 1px solidrgb(109, 117, 0);
            border-radius: 8px;
...
<div class="container">
    <!-- Back Button -->
    <a href="doctor.php" class="btn btn-secondary back-btn">&laquo; Back</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="diagnosisModalLabel">Add Diagnosis</h5>
        ...
        <div class="container">
            <div class="card p-4">
                ...
                <div class="patient-info">
                    <h4 id="modal_patient_info">Patient: <span></span></h4>
                    <a href="#" id="treatmentLink" class="btn btn-primary">View Treatment History</a>
                </div>
                <form id="diagnosisForm" method="post" action="">
                    ...
                    <button type="submit" name="saveDiagnosis" class="btn btn-primary w-100">Save Diagnosis</button>
                </form>
            </div>
        </div>
      </div>
